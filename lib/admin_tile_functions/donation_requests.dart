...
class AdminDonationRequest extends StatefulWidget {
  @override
  _AdminDonationRequestState createState() => _AdminDonationRequestState();
}

class _AdminDonationRequestState extends State<AdminDonationRequest> {
                  ...
                  child: SingleChildScrollView(
                    child: Align(
                      ...
                      child: PaginateFirestore(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          InkWell(
                                            onTap: ()
                                            async{
                                              await FirebaseFirestore.instance.collection('donate_pending').doc('${data['id']}').update({'pending': false})
                                                  .then((value) async{
                        ...
                        query: FirebaseFirestore.instance.collection('donate_pending').where('pending', isEqualTo: false),
