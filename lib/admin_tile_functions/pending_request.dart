...
class AdminPendingRequest extends StatefulWidget {
  @override
  _AdminPendingRequestState createState() => _AdminPendingRequestState();
}
                  ...
                  child: SingleChildScrollView(
                    child: Align(
                      ...
                      child: PaginateFirestore(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          InkWell(
                                            onTap: ()
                                            async{
                                              await FirebaseFirestore.instance.collection('request').doc('${data['id']}').update({'pending': false, 'ngo': 'admin'})
                                                  .then((value) {
                        ...
                        query: FirebaseFirestore.instance.collection('request').where('pending', isEqualTo: true),
