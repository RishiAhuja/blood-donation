        ...
        children: [
          Align(
            alignment: Alignment.center,
              child: Image.asset('assets/search-2.png', width: 40.h, height: 40.h,)
          ),
          Container(
          ...
          InkWell(
            onTap: ()
            {
              Navigator.push(context, MaterialPageRoute(builder: (context) => Donors(district: _district, city: _city, state: _state, blood: bloodGroup)));
            },
            child: Container(
